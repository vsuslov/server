...
protected:
  ...
  bool to_interval_time_only(MYSQL_TIME *to, int *warn) const
  {
    return number_to_time_only(m_neg, m_sec, m_usec,
                               TIME_MAX_INTERVAL_HOUR, to, warn);
  }
  bool to_datetime_or_to_interval_time(MYSQL_TIME *to, int *warn) const
  {
    /*
    ...
    */
    ...
    return to_interval_time_only(to, warn);
  }
public:
